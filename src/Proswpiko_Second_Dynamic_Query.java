...
public class Proswpiko_Second_Dynamic_Query extends javax.swing.JFrame {

    /**
     * Creates new form Proswpiko_Third_Dynamic_Query
     */
    public Proswpiko_Second_Dynamic_Query() {
        initComponents();
        myconnection();
        jLabel2.setText("Βρες τα username του πίνακα Login ανάλογα με τον τύπο τους");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("2ο Δυναμικό Ερώτημα SQL");
        ...
        jLabel3.setText("Παρακαλούμε επιλέξτε τύπο του Login:");
        ...
        buttonGroupType.add(jRadioButtonPatient);
        jRadioButtonPatient.setForeground(new java.awt.Color(240, 240, 240));
        jRadioButtonPatient.setText("Ασθενής");
        jRadioButtonPatient.setIcon(new javax.swing.ImageIcon(getClass().getResource("/patient.png"))); // NOI18N
        ...
        buttonGroupType.add(jRadioButtonStaff);
        jRadioButtonStaff.setForeground(new java.awt.Color(240, 240, 240));
        jRadioButtonStaff.setText("Προσωπικό");
        jRadioButtonStaff.setIcon(new javax.swing.ImageIcon(getClass().getResource("/doctor_staff.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proswpiko_Second_Dynamic_Query().setVisible(true);
            }
        });
    }
    ...
    void myconnection() {
        ...
        try {    
            ...
            String selectType = "SELECT L.username as username\n" +
                                  "FROM Login L\n" +
                                  "WHERE L.typos=?";
            pst = dbConnection.prepareStatement(selectType);
        } catch(SQLException ex) {
            System.out.println("\n -- SQL Exception --- \n");
            while(ex != null) {
		System.out.println("Message: " + ex.getMessage());
