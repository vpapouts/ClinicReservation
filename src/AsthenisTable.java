...
public class AsthenisTable extends javax.swing.JFrame {

    /**
     * Creates new form AsthenisTable
     */
    public AsthenisTable() {
        initComponents();
        myconnection();
        showTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Πίνακας Ασθενών");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Ασθενή", "Επώνυμο", "Όνομα", "Τηλέφωνο", "Φύλο", "Username"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsthenisTable().setVisible(true);
            }
        });
    }
    ...
    // Το αντικείμενο stmt προσφέρει τη δυνατότητα
    // για αποστολή ερωτημάτων στη ΒΔ
    ...
    void myconnection() {
        ...
        try {    
            ...
            /*
            String selectQuery = "SELECT IDAstheni, Epwnymo, Onoma, Thlefwno, \n" + 
                                     "Fylo, Username FROM Asthenis";
