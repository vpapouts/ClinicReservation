...
public class Asthenis_Second_Dynamic_Query extends javax.swing.JFrame {

    /**
     * Creates new form Asthenis_Second_Dynamic_Query
     */
    public Asthenis_Second_Dynamic_Query() {
        initComponents();
        myconnection();
        /*
        ...
        */
        jLabel2.setText("<html>Βρες το ονοματεπώνυμο και την Ειδικότητα των Γιατρών που το επίθετό τους</br>" +
                        "&nbsp;ξεκινάει από συγκεκριμένο γράμμα</html>");
    }
    ...
    private void initComponents() {
        ...
        jComboBoxSpecialty = new javax.swing.JComboBox(surnames);
        ...
        jLabel3.setText("Παρακαλούμε δώστε γράμμα για το επίθετο γιατρού:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Επώνυμο Γιατρού", "Όνομα Γιατρού", "Ειδικότητα"
            }
        ) {
    ...
    private void jComboBoxSpecialtyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxSpecialtyActionPerformed
        ...
        model.setRowCount(0);
        String selectedLetter = String.valueOf(jComboBoxSpecialty.getSelectedItem());
        try {
            pst.setString(1, selectedLetter + "_%");
            rs = pst.executeQuery();
            while(rs.next()) {
                String surname = rs.getString("epwnymo");
                String name = rs.getString("onoma");
                String specialty = rs.getString("eidikothta");
                Object[] row = {surname, name, specialty};
                model.addRow(row);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Asthenis_Second_Dynamic_Query().setVisible(true);
            }
        });
    }
    ...
    String surnames[] = { "Γ", "Ε", "Ζ", "Ι", "Κ", "Μ", "Ν", "Ρ", "Σ", "Χ" };
    ...
    void myconnection() {
        ...
        try {    
            ...
            String selectLetter = "SELECT G.Onoma, G.Epwnymo, G.eidikothta\n" +
                                  "FROM Giatros G\n" +
                                  "WHERE G.Epwnymo LIKE ?";
            pst = dbConnection.prepareStatement(selectLetter);
        } catch(SQLException ex) {
            System.out.println("\n -- SQL Exception --- \n");
            while(ex != null) {
		System.out.println("Message: " + ex.getMessage());
