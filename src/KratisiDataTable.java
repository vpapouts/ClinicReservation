...
public class KratisiDataTable extends javax.swing.JFrame {

    /**
     * Creates new form KratisiDataTable
     */
    public KratisiDataTable() {
        initComponents();
        myconnection();
        showTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Πίνακας με Στοιχεία Κρατήσεων");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Ασθενή", "Όνομα Ασθενή", "Επώνυμο Ασθενή", "ID Γιατρού", "Όνομα Γιατρού", "Επώνυμο Γιατρού", "Ημερομηνία", "Ώρα"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KratisiDataTable().setVisible(true);
            }
        });
    }
    ...
    void showTable() {
        ...
        try {
            ...
            String selectQuery = "SELECT A.IDAstheni, A.Onoma as aname, A.Epwnymo as asurname, \n" +
                                 "G.IDGiatrou, G.Onoma as gname, G.Epwnymo as gsurname, \n" + 
            ...
            while(rs.next()) {
                ...
                Object[] row = {aid, aname, asurname, gid, gname, gsurname, date, time};
                model.addRow(row);
            }
