...
public class ProswpikoTable extends javax.swing.JFrame {

    /**
     * Creates new form ProswpikoTable
     */
    public ProswpikoTable() {
        initComponents();
        myconnection();
        showTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Πίνακας Προσωπικού");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Προσωπικού", "Επώνυμο", "Όνομα", "Θέση", "Τηλέφωνο", "Φύλο", "Username"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProswpikoTable().setVisible(true);
            }
        });
    }
    ...
    void showTable() {
        ...
        try {
            ...
            String selectQuery = "SELECT IDProswpikou, Epwnymo, Onoma, Thesi, Thlefwno, \n" + 
                                 "Fylo, Username FROM Proswpiko";
            rs = stmt.executeQuery(selectQuery);
            while(rs.next()) {
                int id = rs.getInt("IDProswpikou");
                ...
                Object[] row = {id, surname, name, place, pnumber, sex, uname};
                model.addRow(row);
            }
