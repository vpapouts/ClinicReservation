...
public class Proswpiko_Third_Dynamic_Query extends javax.swing.JFrame {

    /**
     * Creates new form Proswpiko_Third_Dynamic_Query
     */
    public Proswpiko_Third_Dynamic_Query() {
        initComponents();
        myconnection();
        jLabel2.setText("Βρες το ονοματεπώνυμο και το username του Προσωπικού ανάλογα με το φύλο του");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Παρακαλούμε επιλέξτε φύλο του προσωπικού:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Όνομα Προσωπικού", "Επώνυμο Προσωπικού", "Username"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proswpiko_Third_Dynamic_Query().setVisible(true);
            }
        });
    }
    ...
    void myconnection() {
        ...
        try {    
            ...
            String selectGender = "SELECT P.Onoma, P.Epwnymo, P.username\n" +
                                  "FROM Proswpiko P\n" +
                                  "WHERE P.Fylo=?";
