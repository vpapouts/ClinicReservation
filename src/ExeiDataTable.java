...
public class ExeiDataTable extends javax.swing.JFrame {

    /**
     * Creates new form ExeiDataTable
     */
    public ExeiDataTable() {
        initComponents();
        myconnection();
        showTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Πίνακας με Στοιχεία Προσωπικού / Γιατρών");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Προσωπικού", "Όνομα Προσωπικού", "Επώνυμο Προσωπικού", "Θέση Προσωπικού", "ID Γιατρού", "Όνομα Γιατρού", "Επώνυμο Γιατρού", "Ειδικότητα Γιατρού"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExeiDataTable().setVisible(true);
            }
        });
    }
    ...
    void showTable() {
        ...
        try {
            ...
            String selectQuery = "SELECT P.IDProswpikou, P.Onoma as pname, P.Epwnymo as psurname, P.Thesi, \n" +
                                 "G.IDGiatrou, G.Onoma as gname, G.Epwnymo as gsurname, G.Eidikothta \n" + 
                                 "FROM Exei E INNER JOIN Proswpiko P ON E.IDProswpikou=P.IDProswpikou \n" +
                                 "INNER JOIN Giatros G ON E.IDGiatrou=G.IDGiatrou \n" +
                                 "ORDER BY G.Eidikothta ASC";
            rs = stmt.executeQuery(selectQuery);
            while(rs.next()) {
                int pid = rs.getInt("IDProswpikou");
                String pname = rs.getString("pname");
                String psurname = rs.getString("psurname");
                String place = rs.getString("Thesi");
                int gid = rs.getInt("IDGiatrou");
                String gname = rs.getString("gname");
                String gsurname = rs.getString("gsurname");
                String specialty = rs.getString("Eidikothta");
                Object[] row = {pid, pname, psurname, place, gid, gname, gsurname, specialty};
                model.addRow(row);
            }
